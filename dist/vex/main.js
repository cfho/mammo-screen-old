...
/* harmony import */ var _iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @iconify/icons-ic/twotone-layers */ 88920);
/* harmony import */ var _iconify_icons_fa_solid_bell_slash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @iconify/icons-fa-solid/bell-slash */ 55445);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/operators */ 88377);
...
class AppComponent {
    constructor(configService, styleService, renderer, platform, document, localeId, layoutService, route, navigationService, splashScreenService, afs) {
         ...
         */
        this.route.queryParamMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(queryParamMap => queryParamMap.has('rtl') && (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_10__.coerceBooleanProperty)(queryParamMap.get('rtl')))).subscribe(isRtl => {
            this.document.body.dir = isRtl ? 'rtl' : 'ltr';
            this.configService.updateConfig({
                rtl: isRtl
            });
        });
        this.route.queryParamMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(queryParamMap => queryParamMap.has('layout'))).subscribe(queryParamMap => this.configService.setConfig(queryParamMap.get('layout')));
        this.route.queryParamMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(queryParamMap => queryParamMap.has('style'))).subscribe(queryParamMap => this.styleService.setStyle(queryParamMap.get('style')));
                ...
                children: [
                    {
                        ...
                        label: 'All-In-One Table',
                        route: '/apps/aio-table',
                        icon: _iconify_icons_fa_solid_bell_slash__WEBPACK_IMPORTED_MODULE_1__["default"]
                    },
                ]
            },
        ];
